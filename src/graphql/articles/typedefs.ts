...
extend type Mutation {
    ...
    updateArticle(id: String!, type: ArticleType, title: String, status: ArticleStatus, description: String, imageId: String, client: String, content: String, format: ArticleContentFormat, doFollowLinks: Boolean, totalCost: Float, currency: String): Article!
